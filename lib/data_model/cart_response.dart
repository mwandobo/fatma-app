...
class CartItem {
  ...
  factory CartItem.fromJson(Map<String, dynamic> json) => CartItem(
    ...
    tax: json["tax"],
    shippingCost: int.tryParse(json["shipping_cost"].toString()),
    quantity: int.tryParse(json["quantity"].toString()),
    lowerLimit: int.tryParse(json["lower_limit"].toString()),
    upperLimit: int.tryParse(json["upper_limit"].toString()),
  );
